...
public class UpdatedUserConsoleOperations extends UserConsoleOperations{
    ...
    private UserConsoleOperations uco;
    private Scanner scanner;

    public UpdatedUserConsoleOperations(UserService userService) {
        super(userService);
        this.scanner = new Scanner(System.in);
        this.uco = new UserConsoleOperations(userService);
    }
    ...
    protected void changeDiscription(){
        System.out.println("Введите измененное почту:");
